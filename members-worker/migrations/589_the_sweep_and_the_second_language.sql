...
--
--   was: ASSERT ALWAYS: SELECT count(*) FROM translations WHERE namespace = 'roi' AND key = 'page.langFallback' AND value LIKE '%{0}%' = 1
--
--
...
-- caught a dropped {0} in a language nobody on the team reads.
--
--   was: ASSERT ALWAYS: SELECT count(*) FROM translations WHERE namespace = 'roi' AND key = 'basis.arShare2.just' AND value LIKE '%{0}%{1}%{2}%{3}%' = 1
--
