...
export const REGION_ORDER = ["Europe", "Middle East", "Asia-Pacific", "Americas"];
...
export const REGION_BOUNDS = {
  "Europe": [[-11, 34], [35, 34], [35, 71.5], [-11, 71.5]],
  "Middle East": [[22, 14], [58, 14], [58, 34], [22, 34]],
...
export const MAP_UI = {
  en: {
    ...
    regionNotes: {
      ...
      "Middle East": "The most naturally compact of the non-European regions — all tracked countries here sit close together.",
  ...
  es: {
    ...
    regionNotes: {
      ...
      "Middle East": "La región no europea más compacta — los países rastreados están muy cerca entre sí.",
  ...
  de: {
    ...
    regionNotes: {
      ...
      "Middle East": "Die kompakteste der nicht-europäischen Regionen — die erfassten Länder liegen eng beieinander.",
  ...
  fr: {
    ...
    regionNotes: {
      ...
      "Middle East": "La région non européenne la plus compacte — les pays suivis sont proches les uns des autres.",
