...
--
--   was: ASSERT ALWAYS: SELECT count(*) FROM translations WHERE namespace = 'roi' AND key IN ('guard.late.one','guard.late.other','guard.mistimed.one','guard.mistimed.other') AND value LIKE '%{0}%' AND value LIKE '%{1}%' = 4
--
--
