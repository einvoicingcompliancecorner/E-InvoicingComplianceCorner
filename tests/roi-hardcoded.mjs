...
const KNOWN = new Set([
  ...
  "# of your jurisdictions publish a quantified penalty schedule",
  ...
  "(#-corner exchange) regimes, plus # with no mandate",
  "(CTC or #-corner) and",
  "(Poland).",
  "(updated Jan #)",
  ". Size it from those, per country — there is no credible aggregate",
  ". With # ERP/billing system that is roughly",
  ". Your # AP invoices imply",
  "; # clearance or reporting jurisdictions put",
  "; your own spend is the better input",
  "APQC median, # per FTE",
  "ATO / Deloitte task times",
  "Across",
  "Already in force, no further dated step (#):",
  "Ardent Partners, # data",
  "Avoided rework on data-entry errors",
  ...
  "Evidence grade C",
  "Evidence grade D",
  "Fraud detection, working-capital visibility",
  "Go-live",
  "HMRC / DBT consultation #",
  "Integrations",
  "Issuing cost reduction (AR)",
  "Jurisdiction",
  ...
  "Mechanism evidenced",
  "Model",
  "No mandate, included by your selection (#):",
  "Often quoted,",
  "Our assumption, capped by Ardent exception gap",
  "Paper AUD #.# vs e-invoice AUD #.#",
  "Paper, print, postage, storage",
  "Penalty & remediation exposure avoided",
  "Phase",
  ...
  "Pinned start",
  "Poland — #-#-# (planned for #-#-#); Portugal — #-#-# (planned as discretionary). These are dated, live obligations that the arrivals board does not display, so the wave plan below does not schedule them. The runway shown for them is longer than the runway they actually have.",
  "Processing cost reduction (AP)",
  "Reduced tax reporting & audit-prep effort",
  "Select & contract",
  "Source: live tracker data",
  "Starts within # months",
  "Status",
  "Strategic benefits; no benchmark exists",
  "VAT leakage / gap recovery",
  ...
  "reduction",
  "source",
  "to deliver. The nearest binding date is",
  ...
  "— excluded from this model entirely",
  "▲ already late",
  "● start <#d",
  "✓ runway",
]);
